...
class PatientSummaryScreenControllerTest {
  ...
  private fun `params for patient summary populating profile`() = listOf(
      listOf(ViewExistingPatient, PatientMocker.businessId(patientUuid = patientUuid, identifier = Identifier("bp-pass", BpPassport))),
      listOf(ViewExistingPatient, null),
      listOf(ViewNewPatient, PatientMocker.businessId(patientUuid = patientUuid)),
      listOf(ViewNewPatient, null),
      listOf(LinkIdWithPatient(Identifier("06293b71-0f56-45dc-845e-c05ee4d74153", BpPassport)), PatientMocker.businessId(patientUuid = patientUuid)),
      listOf(LinkIdWithPatient(Identifier("06293b71-0f56-45dc-845e-c05ee4d74153", BpPassport)), null)
  )
